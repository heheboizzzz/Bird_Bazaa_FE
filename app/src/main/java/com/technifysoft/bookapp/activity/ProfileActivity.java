...
import com.technifysoft.bookapp.adapter.AdapterPdfFavorite;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    private void emailVerificationDialog() {
        ...
        builder.setTitle("Verify Email").setMessage("Are you sure you want to send email verification instructions to your email " + firebaseUser.getEmail()).setPositiveButton("SEND", new DialogInterface.OnClickListener() {
            @Override
        ...
        ref.child(firebaseAuth.getUid()).child("Favorites").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds : snapshot.getChildren()) {
                    //get the bookId here, and got other details in adapter using that bookId
