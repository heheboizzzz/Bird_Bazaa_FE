...
import com.technifysoft.bookapp.constrant.Constants;
...
public class PdfViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //get bookId from intent that passed in intent
    ...
    private void loadBookDetails() {
        ...
        //Database Reference to get book details (get book url using book id)
    ...
    private void loadBookFromUrl(String pdfUrl) {
        ...
        reference.getBytes(Constants.MAX_BYTES_PDF).addOnSuccessListener(new OnSuccessListener<byte[]>() {
            ...
            public void onSuccess(byte[] bytes) {
                ...
                binding.pdfView.fromBytes(bytes).swipeHorizontal(false) //set false to scroll vertical, set true to swipe horizontal
